...
static std::map<void *, Timer_t *> timersMap;

void Timer_t::internalCallback(TimerHandle_t xTimer) {
	Timer_t *timer = timersMap.at(xTimer);
 ...
 */
void Timer_t::Start(TickType_t blockTime) {
 ...
 */
void Timer_t::Stop(TickType_t blockTime) {
 ...
 */
void Timer_t::Reset(TickType_t blockTime) {
 ...
 */
void Timer_t::ChangePeriod(TickType_t newPeriod, TickType_t blockTime) {
